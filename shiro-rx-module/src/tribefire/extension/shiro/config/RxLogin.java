...
public interface RxLogin extends RxServlet {

	EntityType<RxLogin> T = EntityTypes.T(RxLogin.class);

	@Initializer("false")
	Boolean getCreateUsers();
	void setCreateUsers(Boolean createUsers);

	RxNewUserRoleProvider getNewUserRoleProvider();
	void setNewUserRoleProvider(RxNewUserRoleProvider newUserRoleProvider);
