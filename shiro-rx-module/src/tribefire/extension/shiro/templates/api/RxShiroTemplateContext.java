...
public interface RxShiroTemplateContext {

	static RxShiroTemplateContextBuilder builder() {
		return new RxShiroTemplateContextImpl();
	}
	...
	AccessContract getAccessContract();
